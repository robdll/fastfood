...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      ordersTitle: 'Orders',
      ordersBody: 'Review incoming orders and update their status.',
      ordersAction: 'View orders',
      statsTitle: 'Statistics',
      statsBody: 'Track your restaurant performance over time.',
    ...
    clientDashboard: {
      ...
      dishTitle: 'Dish of the day',
      dishBody: '{name}',
      cheapestTitle: 'Cheapest item',
      cheapestBody: '{name} - {price}',
      promoTitle: 'Restaurant with promo',
      promoBody: '{name}',
      promoAction: 'Checkout menu',
      highlightEmpty: 'Not enough data yet.',
      highlightsError: 'Unable to load highlights.',
    },
    restaurantStats: {
      title: 'Restaurant statistics',
      body: 'Review orders and performance highlights.',
      orders: 'Number of orders',
      mostSold: 'Most sold items',
      totalGains: 'Total gains since opening',
    ...
    clientMenu: {
      ...
      searchPlaceholder: 'Search by type, name, price, or ingredient',
    ...
    clientCart: {
      ...
      checkoutError: 'Unable to complete the purchase.',
    ...
    clientOrders: {
      ...
      tableTotal: 'Line total',
      markDelivered: 'Mark delivered',
      statusOrdered: 'Ordered',
      statusPreparation: 'Preparation',
      statusReadyForPickup: 'Ready for pickup',
      statusDelivered: 'Delivered',
      statusUpdatedDelivered: 'Order marked as delivered.',
    },
    restaurantOrders: {
      title: 'Orders',
      body: 'Incoming orders are listed below.',
      empty: 'No orders yet.',
      orderLabel: 'Order #{id}',
      placedOn: 'Placed on {date}',
      orderType: 'Order type',
      ...
      tableUnit: 'Unit price',
      tableTotal: 'Line total',
      markPreparation: 'Mark in preparation',
      ...
      statusReadyForPickup: 'Ready for pickup',
      statusDelivered: 'Delivered',
      statusUpdatedPreparation: 'Order marked as in preparation.',
      statusUpdatedReadyForPickup: 'Order marked as ready for pickup.',
      statusUpdatedDelivered: 'Order marked as delivered.',
    },
    settings: {
      title: 'User settings',
  ...
  it: {
    ...
    dashboard: {
      ...
      ordersTitle: 'Ordini',
      ordersBody: 'Controlla gli ordini in arrivo e aggiorna lo stato.',
      ordersAction: 'Vedi ordini',
      statsTitle: 'Statistiche',
      statsBody: 'Monitora le performance del ristorante nel tempo.',
      statsAction: 'Vedi statistiche',
    ...
    clientDashboard: {
      ...
      dishTitle: 'Piatto del giorno',
      dishBody: '{name}',
      cheapestTitle: 'Piatto piu economico',
      cheapestBody: '{name} - {price}',
      promoTitle: 'Ristorante in promo',
      promoBody: '{name}',
      promoAction: 'Guarda menu',
      highlightEmpty: 'Non ci sono ancora dati disponibili.',
      highlightsError: 'Impossibile caricare i suggerimenti.',
    },
    restaurantStats: {
      title: 'Statistiche ristorante',
      body: 'Controlla ordini e performance.',
      orders: 'Numero di ordini',
      mostSold: 'Piatti piu venduti',
      totalGains: 'Guadagni totali dall apertura',
      bestCustomer: 'Miglior cliente',
      soldCount: '{count} venduti',
      empty: 'Non ci sono dati disponibili.',
      unknownCustomer: 'Cliente',
    },
    clientRestaurants: {
      title: 'Ricerca ristorante',
      body: 'Seleziona un ristorante per consultare il menu.',
      searchLabel: 'Cerca ristoranti',
    ...
    clientMenu: {
      ...
      searchPlaceholder: 'Cerca per tipo, nome, prezzo o ingrediente',
    ...
    clientCart: {
      ...
      checkoutError: "Impossibile completare l'acquisto.",
    ...
    clientOrders: {
      ...
      tableItem: 'Articolo',
      tableQty: 'Qta',
      tableUnit: 'Prezzo unitario',
      tableTotal: 'Totale riga',
      ...
      statusUpdatedDelivered: 'Ordine segnato come consegnato.',
    },
    restaurantOrders: {
      title: 'Ordini',
      body: 'Gli ordini in arrivo sono elencati qui sotto.',
      empty: 'Nessun ordine ancora.',
      orderLabel: 'Ordine #{id}',
      placedOn: 'Inviato il {date}',
      orderType: 'Tipologia ordine',
      typeDelivery: 'Consegna',
      typePickup: 'Ritiro',
      ...
      tableUnit: 'Prezzo unitario',
      tableTotal: 'Totale riga',
      markPreparation: 'Segna in preparazione',
      markReady: 'Segna pronto per il ritiro',
      markDelivered: 'Segna consegnato',
      statusOrdered: 'Ordinato',
      statusPreparation: 'In preparazione',
      statusReadyForPickup: 'Pronto per ritiro',
      statusDelivered: 'Consegnato',
      statusUpdatedPreparation: 'Ordine segnato in preparazione.',
      statusUpdatedReadyForPickup: 'Ordine segnato pronto per il ritiro.',
      statusUpdatedDelivered: 'Ordine segnato come consegnato.',
    },
    settings: {
